...
export const jaMessages: LocaleMessages = {
  ...
  about: {
    ...
    missionBody: `${secretKeeperName}は、経験、関心、境界線を整理し、自分を理解していく道のりが少しでも孤独でないよう、そばにいます。あなたが望むなら、これは誰かに渡して、あなたを知ってもらうための招待状にもなります。秘密ファイルはあくまで対話のきっかけであり、その都度の確認と同意に代わるものではないことにも、ご注意ください。`, missionTitle: '境界線と好みを、もっとはっきり表現する',
