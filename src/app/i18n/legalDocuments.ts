  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        title: '二、本站的用途與內容提醒',
        paragraphs: [
          '本站是一本協助自我理解與 BDSM（愉虐）互動界限溝通的筆記本。內容可能提及性、身體、權力交換與高風險互動項目；請依自己的狀態決定是否繼續閱讀。',
...
export const zhHansLegal = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: '二、本站的用途与内容提醒', paragraphs: ['本站是一本协助自我理解与 BDSM（愉虐）互动界限沟通的笔记本。内容可能提及性、身体、权力交换与高风险互动项目；请依自己的状态决定是否继续阅读。', '本站不从事社交或配对，不鼓励任何特定行为，也不把使用者分类成固定的属性或角色。本站不提供医疗、法律、心理治疗或 BDSM 操作建议，也不能取代合格专业人员的意见。'] },
...
export const jaLegal = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: '2. 目的と内容に関する注意', paragraphs: ['本サイトは、自己理解とBDSMに関する相互行為の境界線の対話を支えるノートです。性、身体、パワー・エクスチェンジ、高リスクな行為に触れる場合があります。ご自身の状態に合わせて閲覧を続けるか判断してください。', '本サイトは交流・マッチングを行わず、特定の行為を推奨せず、利用者を固定的な属性や役割に分類しません。医療、法律、心理療法、BDSMの実践方法に関する助言は提供せず、専門家の助言に代わるものではありません。'] },
